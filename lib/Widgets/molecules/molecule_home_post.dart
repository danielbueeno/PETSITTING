...
class MoleculeHomePost extends StatefulWidget {
  const MoleculeHomePost({super.key,required this.name, required this.description, required this.profileImage, required this.likes, required this.postImage});
...
class _MoleculeHomePostState extends State<MoleculeHomePost> {
  ...
  Widget get _likeButton{
    return GestureDetector(
      onTap: _onClickLike,
      child:!_likedPost? const Icon(Icons.favorite_border_outlined): 
